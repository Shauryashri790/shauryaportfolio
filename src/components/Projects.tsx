  ...
  return (
    <section id="projects" className="py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <article className="group relative grid lg:grid-cols-5 gap-0 rounded-3xl overflow-hidden bg-card border border-border hover:border-primary/50 transition-all mt-8">
          {/* Visual side */}
          <div className="lg:col-span-2 relative bg-gradient-to-br from-primary/20 via-surface-elevated to-surface p-10 min-h-[280px] flex items-center justify-center">
            <Zap className="w-32 h-32 text-primary/80 group-hover:scale-110 transition-transform duration-500" strokeWidth={1.2} />
            <div className="absolute top-6 left-6 inline-flex items-center gap-2 text-xs font-mono px-3 py-1.5 rounded-full bg-background/80 backdrop-blur border border-primary/30 text-primary">
              <Trophy className="w-3.5 h-3.5" /> National Level Hackathon
            </div>
          </div>
          ...
          <div className="lg:col-span-3 p-8 lg:p-10">
            <div className="flex flex-wrap items-center gap-3 mb-4 text-xs font-mono">
              <span className="px-2.5 py-1 rounded-full bg-surface-elevated text-muted-foreground">Hackathon</span>
              <span className="px-2.5 py-1 rounded-full bg-surface-elevated text-muted-foreground">Web</span>
              <span className="px-2.5 py-1 rounded-full bg-surface-elevated text-muted-foreground">Maps & Navigation</span>
            </div>
            <h3 className="font-display text-2xl sm:text-3xl font-bold mb-3">
              EV Charging Station Locator & Navigator
            </h3>
            <p className="text-muted-foreground leading-relaxed mb-6">
              A website that helps EV drivers locate the nearest charging stations and navigate to them in real time. Built and showcased at a national-level hackathon, focused on making electric mobility more accessible across India.
            </p>
            <div className="flex items-center gap-6 text-sm text-muted-foreground mb-8">
              <span className="inline-flex items-center gap-2">
                <Users className="w-4 h-4 text-primary" /> Team project
              </span>
              <span className="inline-flex items-center gap-2">
                <Trophy className="w-4 h-4 text-primary" /> National level
              </span>
            </div>
            <div className="flex flex-wrap gap-3">
              <a
